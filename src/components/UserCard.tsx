...
export default function UserCard() {
  return (
    <section className="grid grid-cols-cards gap-4">
      <div
        className="bg-card border border-border rounded-2xl p-6 overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:border-accent/30 animate-fadeUp relative before:absolute before:top-0 before:left-0 before:right-0 before:h-px
